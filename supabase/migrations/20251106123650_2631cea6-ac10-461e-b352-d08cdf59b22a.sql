-- Create a function to get uncalled leads for an agent (much faster than client-side filtering)
...
GRANT EXECUTE ON FUNCTION get_agent_uncalled_leads(UUID) TO authenticated;